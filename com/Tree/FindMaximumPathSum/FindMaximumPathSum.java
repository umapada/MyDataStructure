package com.Tree.FindMaximumPathSum;
...
class FindMaximumPathSum {
    ...
    int maxPathSumUtil(TreeNode node, Res res) {
        ...
        if (node.left == null && node.right == null)
            return node.data;
        // Find maximum sum in left and right subtree. Also find maximum root to leaf sums in left and right
    ...
    // The main function which returns sum of the maximum sum path between two leaves. This function mainly
    // uses maxPathSumUtil()
    ...
    public static void main(String args[]) {
        FindMaximumPathSum tree = new FindMaximumPathSum();
