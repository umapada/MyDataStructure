package com.Tree.DiagonalSumBinaryTree;

import java.util.*;
import java.util.Map.Entry;

/**
 * Consider lines of slope -1 passing between nodes (dotted lines in below diagram). Diagonal sum in a binary tree is
 * sum of all node’s data lying between these lines. Given a Binary Tree, print all diagonal sums.
 *
...
/**
 * Algorithm:
 * The idea is to keep track of vertical distance from top diagonal passing through root. We increment the vertical
 * distance we go down to next diagonal.
 ...
 * 3. Add left child current node into the queue for later processing. The vertical distance of left child is vertical
 * distance of current node plus 1.
...
class DiagonalSumBinaryTree
{
    ...
    // Tree constructor
    public DiagonalSumBinaryTree(TreeNode root)  {  this.root = root;  }
