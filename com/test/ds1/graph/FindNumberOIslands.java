 ...
 * the whole graph. Such a graph with only one connected component is called a Strongly Connected Graph.
 *
    ...
    int countIslands(int M[][])
    {
        ...
        for (int i = 0; i < ROW; ++i)
            for (int j = 0; j < COL; ++j)
                ...
                { // value 1 is not visited yet, then new island found, Visit all cells in this island
