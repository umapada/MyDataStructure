...
public class RansomNote {
	public static void main(String[] args) {
		if (args.length < 2) {
			System.out
					.println("You need to enter a ransom note and the " + "contents of the magazines both in quotes.");
			System.exit(1);
		}
	 ...
	 * ransom note string and another string containing all the contents of all the
	 * magazines, write a function that will return true if the ransom note can be
	 * made from the magazines; otherwise, it will return false. Every letter found
