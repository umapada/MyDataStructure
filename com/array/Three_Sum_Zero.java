...
possible first element we make a standard bi-directional 2Sum sweep of the remaining part of the array. Also we want to
...
public class Three_Sum_Zero {
    ...
    static List<List<Integer>> threeSum(int[] num) {
        ...
        for (int i = 0; i < num.length-2; i++) {
            ...
            //If first element is not negative, break
            if(num[i]>0) break;
